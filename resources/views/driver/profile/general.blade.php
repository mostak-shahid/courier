    ...
    <div class="content-wrapper">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{route('driver')}}">Home</a></li>
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                @endif
                <form id="validteForm" action="{{ route('driver.profile.general.update', ['id'=>$user->id]) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-lg-6">
