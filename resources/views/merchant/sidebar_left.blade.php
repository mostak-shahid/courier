...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
                <a href="{{route('merchant')}}" class="d-block">{{ Auth::user()->name }}</a>
            </div>
        </div>
    ...
    <!-- Sidebar Menu -->
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item {{ (request()->is('merchant/profile*')) ? 'menu-open' : '' }}">
                    <a href="#" class="nav-link {{ (request()->is('merchant/profile*')) ? 'active' : '' }}">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{route('merchant.profile.general')}}" class="nav-link {{ (request()->is('merchant/profile/general')) ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>General</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('merchant.profile.changepassword')}}" class="nav-link {{ (request()->is('merchant/profile/changePassword')) ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Change Password</p>
                            </a>
                        </li>
