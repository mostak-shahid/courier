...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            <div class="container-fluid">
                <form id="validteForm" action="{{ route('admin.merchants.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <div class="text-center mt-2"><img class="img-fluid d-none img-uploader-output" id="uploaded-img" src="#" alt="Profile image" /></div>
                                        @if ($errors->has('buseness_logo'))
                                            <div class="text-danger mb-3"><strong>{{ $errors->first('buseness_logo') }}</strong></div>
                                        @endif
                                    </div>
                                    <div class="form-group mb-3">
