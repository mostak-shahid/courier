...
@section('content')
    ...
    <div class="content-wrapper">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a href="{{route('admin.drivers')}}">All Drivers</a></li>
        ...
        <div class="content">
            <div class="container-fluid">
                <form id="validateForm" action="{{ route('admin.merchants.updatepassword', ['id'=>$user->id]) }}" method="post">
                    @csrf
                    <div class="row">
